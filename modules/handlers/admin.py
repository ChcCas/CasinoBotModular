...
async def admin_panel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.callback_query:
        ...
        await update.message.reply_text("🛠 Адмін-панель", reply_markup=admin_panel_kb())
    return STEP_MENU
...
# === Обробка кнопки "Назад" або "Головне меню" ===
    ...
    conv = ConversationHandler(
        ...
        states={
            STEP_MENU: [
                ...
                CallbackQueryHandler(go_back, pattern="^(back|home)$"),
            ],
            STEP_ADMIN_SEARCH: [
